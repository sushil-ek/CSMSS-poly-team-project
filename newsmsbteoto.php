        ...
        <div class="department-single-area py-120">
            ...
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                        ...
                        <h2 class="mt-4">MSBTE One time opportunity (OTO) registration time table 2022-23..</h2>
                                    <br>

                                <img src="assets/img/news-and-events/news/msbte-oto-time-table-22-23.png" style=" width: 100%;"  class="card shadow-lg"><br>
                                As per the MSBTE circular dated 29 August 2022, regarding one time opportunity (OTO), MSBTE has declared the time table for registration for the same. To see the full details download the circular from HERE.
                                 <br>
