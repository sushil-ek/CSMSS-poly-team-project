        ...
        <div class="department-single-area py-120 faq-area">
            ...
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                       ...
                       <h2 class="mt-4">POST SSC Diploma admission circular..</h2>   
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news-and-events/news/post-ssc.jpg" class="card shadow-lg" style=" width: 100%;"   alt="thumb">
</div>
                   POST SSC Diploma admission circular.last date for Registration is 07/07/2023.
