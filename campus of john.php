        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recruitment of john deere images/welcome board.jpg">
                    <img src="assets/img/photos-Gallery/campus recruitment of john deere images/welcome board.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recruitment of john deere images/induction photo.jpg">
                    <img src="assets/img/photos-Gallery/campus recruitment of john deere images/induction photo.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recruitment of john deere images/campus interview.jpg">
                    
                    <img src="assets/img/photos-Gallery/campus recruitment of john deere images/campus interview.jpg " class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recruitment of john deere images/interview of student.jpg">
                    <img src="assets/img/photos-Gallery/campus recruitment of john deere images/interview of student.jpg" class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>

            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recruitment of john deere images/class two.jpg">
                    <img src="assets/img/photos-Gallery/campus recruitment of john deere images/class two.jpg" class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
