                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr>
                                            ...
                                            <!-- <td><a href="../../civil-department.php">link</a></td> -->
                                            <td>
                                                <div>
                                                    <a href="edit_Department.php" class=" text-white">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <a href="../../electrical-department.php">link</a>
                                            </td> -->
                                            </td>

                                            <td>
                                                <div> <a href="edit_Department.php" class=" text-white">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <a href="../../mechanical-department.php">link</a>
                                            </td> -->
                                            </td>
                                            <td>
                                                <div> <a href="edit_Department.php" class=" text-white">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <a href="../../computer-department.php">link</a>
                                            </td> -->
                                            </td>
                                            <td>
                                                <div> <a href="edit_Department.php" class=" text-white">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <a href="../../electronics-telecommunication-department.php">link</a>
                                            </td> -->
                                            </td>
                                            <td>
                                                <div> <a href="edit_Department.php" class=" text-white">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <a href="../../AI-ML-department.php">link</a>
                                            </td> -->
                                            </td>
