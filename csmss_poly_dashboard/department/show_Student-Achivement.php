            ...
            <div class="card">
              ...
              <div class="tab-content">
                <div id="Civil" class="tab-pane fade in active">
                  <div class="row">
                    <div class="col-lg-6 ">
                      <div class="h5 card-header">STUDENT ACHIEVEMENT DETAIL'S </div>
                    </div>
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                          <td>01</td>
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Indian Society for Technical Education (ISTE), New Delhi.</strong></td>
                          <td>2023-24</td>
                          <td>ISTE</td>
                        ...
                        <tr>
                          <td>02</td>
                          <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong> IEDSSA (Inter Engineering Diploma Students Sport Association.) in Football</strong></td>
                          <td>2023-24</td>
                          <td>IEDSSA</td>
                          <td>
                        ...
                        <tr>
                          <td>03</td>
                          <td><i class="fab fa-vuejs fa-lg text-success me-3"></i> <strong> IEDSSA (Inter Engineering Diploma Students Sport Association.) in Table Tennis</strong></td>
                          <td>2023-24</td>
                          <td>
                            IEDSSA
                          </td>
                        ...
                        <tr>
                          ...
                          <td>Om Wankar, Digvijay Chavan</td>
                          <td>Participant</td>
                          <td>Civil</td>
                          <td>
                            <div> <a href="edit_Student-Achivement.php" class=" text-white">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                          ...
                          <td>2023-24</td>
                          <td>CSMSS,College of Polytechnic
                          </td>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody class="table-border-bottom-0">
                        <tr>
                          ...
                          <td>Mehta Krish Manoj,Pathe Mrutyunjay Kishor</td>
                          <td>Winner</td>
                          <td>Computer </td>
                          <td>
                            <div> <a href="edit_Student-Achivement.php" class=" text-white">
                        ...
                        <tr>
                          ...
                          <td>Markar Vaidehi Raju, Kubade Priti Ashok</td>
                          <td>Runner up</td>
                          <td>Computer </td>
                          <td>
                            <div> <a href="edit_Student-Achivement.php" class=" text-white">
                        ...
                        <tr>
                          ...
                          <td>Sukase Ishwari Shivaji, Devre Kalyani Pradip, Hingmire Bhakti Anand,Edke Pranjal Santosh</td>
                          <td>
                            Runner up</td>
                          <td>Computer </td>
                          <td>
