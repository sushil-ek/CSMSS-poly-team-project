        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                 data-src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/interview.jpg">
                    <img src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/interview.jpg" class=" card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/campus.jpg">
                    <img src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/campus.jpg" class="card shadow-lg"style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/campus front board.jpg ">
                    <img src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/campus front board.jpg " class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/congrats banner.jpg">
                    <img src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/congrats banner.jpg"class="card shadow-lg"style="height:250px; width:300px;">
                </a>
            </div>

            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/staff.jpg">
                    <img src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/staff.jpg" class="card shadow-lg"style="height:250px; width:300px;">
                </a>
            </div>

            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/staff with stu.jpg">
                    <img src="assets/img/photos-Gallery/campus drive for electrical & mechanical enineering students/staff with stu.jpg" style="height:250px; width:300px;">
                </a>
            </div>
