        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of john deere/front welcome board.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of john deere/front welcome board.jpg"  class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of john deere/staff.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of john deere/staff.jpg"  class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of john deere/staff2.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of john deere/staff2.jpg " class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of john deere/teacher wel.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of john deere/teacher wel.jpg" class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
