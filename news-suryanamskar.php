...
<div class="col-xl-8 col-lg-8" style="overflow-y:auto; scrollbar-width: none; min-height: 100vh;">
        ...
        </nav>                           <h1 style=" border-bottom: 3px solid orange;">NEWS</h1>
                      
                       <h2 class="mt-4">Organized Virtual Surya Namaskar Programme Event held at CSMSS College of Polytechnic..</h2>   
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news-and-events/news/org-surya-namskar.jpg" class="card shadow-lg" style=" width: 100%;"   alt="thumb">
                                </div>
