...
<div class="col-xl-8 col-lg-8" style="overflow-y:auto; scrollbar-width: none; min-height: 100vh;">
            ...
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                       ...
                       <h2 class="mt-4">छत्रपती शाहू पॉलिटेक्निक व मसिआमध्ये सामंजस्य करार..</h2>   
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news-and-events/news/csmss-masiaam-karar.jpeg" class="card shadow-lg" style=" width: 100%;"  alt="thumb"></div>
