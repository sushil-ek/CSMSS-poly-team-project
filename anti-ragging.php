                            ...
                            <div class="department-sidebar">
                                <div class="widget category">
                                    ...
                                    <div class="category-list">
                                        ...
                                        <a href="ssc diploma.php"><i class="far fa-long-arrow-right"></i>POST SSC Diploma admission circular</a>
                                        ...
                                        <a href="news appointment"><i class="far fa-long-arrow-right"></i>Appointment of various posts 2023</a>
                                        <a href="newspaper-prasentaion"><i class="far fa-long-arrow-right"></i>State Level Technical Paper Presentation Competition</a>
                                        <a href="news selected-candidate"><i class="far fa-long-arrow-right"></i>List of selected candidates in John Deere India Pvt Ltd. 2022-23</a>
                                        ...
                                        <a href="newspolytecnic.php"><i class="far fa-long-arrow-right"></i>छत्रपती शाहू पॉलिटेक्निक व मसिआमध्ये सामंजस्य करार</a>
                                        
                                        <a href="newssscdeploma"><i class="far fa-long-arrow-right"></i>Post SSC Diploma/Polytechnic admissions Facilitation Center 2176</a>
                                        <a href="newsonline stu.php"><i class="far fa-long-arrow-right"></i>online student grievance notice</a>
                                        <a href="newstime table.php"><i class="far fa-long-arrow-right"></i>Class test 1 time table (s-2022)</a>
                                        ...
                                        <a href="news trantrashikashan.php"><i class="far fa-long-arrow-right"></i>तंत्रशिक्षण पदविका प्रवेश – थोडक्यात माहिती</a>
                                        <a href="newspadma-vibhushan"><i class="far fa-long-arrow-right"></i>Padma-vibhushan Hon. Dr. Anil Kakodkar inaugurates CSMSS SAT-COM lab</a>
                                        <a href="news fees 2017-18"><i class="far fa-long-arrow-right"></i>CSMSS College of Polytechnic Fees for academic year 2017-18</a>
                                        <a href="news signed mambership.php"><i class="far fa-long-arrow-right"></i>MOU has signed with Nashik Engineering Cluster</a>
                                        <a href="news poly best option.php"><i class="far fa-long-arrow-right"></i>Polytechnic is the best option After tenth in order to get early jobs:  Dr. M. V. Mankar</a>
                      ...
                      <hr>
                       ...
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news and events/news/anti-ragging.jpeg"style=" width:100%;"  alt="thumb">
                                </div>


<h6>this committee is formed to ensured complete ragging free environment in CSMSSCOP Campus as per the guidlines of AICTE ,New Delhi.

Important Links
        
web counter
Visitor Counter
© 2016 College of Polytechnic. All Rights Reserved.

 
Designed & Developed By Deven Infotech</h6>
