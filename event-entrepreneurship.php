                                    ...
                                    <div id="carouselExampleDark" class="carousel carousel-dark slide widget category">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="10000">
                                                <div style="min-height: 200px;">
                                                    <div class="carousel-caption d-block text-start py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news text-center">On the occasion of the death anniversary, a heartfelt tribute to Chhatrapati Shahu Maharaj.</strong>
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="news ps-5">National Road Safety Week</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="news ps-5">School Connect Program</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="text-center ps-5 news">Hackathon-2023</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="news ps-5">Placement in Forbes and Company</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="news ps-5">National Conference 2022-23</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="news ps-5">IEDSSA 2022-23 G-1 ZONE GLIMPSE</strong>
                                                        <center>
                                                            <div class="department-btn">
...
<div class="col-12 col-lg-6 col-md-6 mt-5">
     <img src="assets/img/news-and-events/Events/Expert-talk-entrepreneurship/career1.jpeg"alt="thumb" class="w-100 card shadow-lg" style="height:200px; ">
                                    

</div>
                            
 <div class="col-12 col-lg-6 col-md-6 mt-5">
    <img src="assets/img/news-and-events/Events/Expert-talk-entrepreneurship/career2 .jpeg"alt="thumb" class="w-100 card shadow-lg" style="height:200px; ">

</div>
 <div class="col-12 col-lg-6 col-md-6 mt-5"> <img src="assets/img/news-and-events/Events/Expert-talk-entrepreneurship/career3.jpeg"alt="thumb" class="w-100 card shadow-lg" style="height:200px; ">
...
<!--row3-->
<div class="col-12 col-lg-6 col-md-6 mt-5">
                <img src="assets/img/news-and-events/Events/Expert-talk-entrepreneurship/career4.jpeg"alt="thumb" class="w-100 card shadow-lg" style="height:200px; ">
