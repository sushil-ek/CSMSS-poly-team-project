                                    ...
                                    <div id="carouselExampleDark" class="carousel carousel-dark slide widget category">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="10000">
                                                <div style="min-height: 200px;">
                                                    <div class="carousel-caption d-block text-start py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Mechanical Engineering Department Second year students got second price</p>
                                            ...
                                            <div class="carousel-item" data-bs-interval="10000">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Refresher Course for Direct Second Year Students</p>
                                            ...
                                            <div class="carousel-item" data-bs-interval="10000">
                                                <div style="min-height: 200px;">
                                                    <div class="carousel-caption d-block text-start pt-5" style=" font-size: 15px">
                                                        <p class=" center">Institute Level Admission Round 2023-24</p>
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class= "center">OTO Registration Circular</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Anti-Ragging Committee</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">ICC(Internal Complaint Committee) Committee</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Grievance Redressal Committee(GRC) for Faculty/Staff</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">POST SSC Diploma admission circular</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Photocopy Schedule</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">150th Birth Anniversary Celebration of Chhatrapati Rajarshi Shahu Maharaj</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Umesh Nagdive Sir has Visited FC Center(CSMSS COP)</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Appointment of various posts 2023</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">State Level Technical Paper Presentation Competition</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">List of selected candidates in John Deere India Pvt Ltd. 2022-23</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Class test 1 time table AY 2022-23 (Even)</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">जॉन डियर इंडिया प्रा.ली. तर्फे कॅम्पस ड्राईव्ह</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Fees structure for academic year 2022-23</p>
                                                                <center>
                                                                    <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Corruption Free India For a Developed Nation</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Against CAP General Merit List A.Y. 2022-23 </p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">MSBTE One time opportunity (OTO) registration time table 2022-23</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">पॉलिटेक्निक शैक्षणिक वर्ष २०२२-२३ अनुत्तीर्ण विद्यार्थांना दिलासा</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">CSMSS Polytechnic च्या सर्व शाखांना MSBTE कडून excellent दर्जा</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">छत्रपती शाहू पॉलिटेक्निक व मसिआमध्ये सामंजस्य करार</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Post SSC Diploma/Polytechnic admissions Facilitation Center 2176</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">online student grievance notice</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Class test 1 time table (s-2022)</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">छत्रपती शाहू पॉलीटेक्निकने राखली निकालाची उज्ज्वल परंपरा</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">छत्रपती शाहू पॉलीटेकनिक मधील २४ विद्यार्थ्यांची कॅम्पस प्लेसमेंट</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">MAGICx Interview Series Announcement for 15 January 2022!</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Organized Virtual Surya Namaskar Programme Event held at CSMSS College of Polytechnic.</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Arrangement of Covid-19 Mega Vaccination for all the students who are above 15 years old on the Occasion of National Youth Day January 12, 2022.</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Visit of Delegation of Directorate of Technical Education, Uttar Pradesh for Study tour of Polytechnic Colleges in Maharashtra.</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Arrangement of Special vaccination drive against corona virus disease (Covid-19) at CSMSS College of Polytechnic
                                                        </p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">TC Issue of Final year Pass out student</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 270px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Padma-vibhushan Hon. Dr. Anil Kakodkar inaugurates CSMSS SAT-COM lab.</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">CSMSS College of Polytechnic Fees for academic year 2017-18</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">MOU has signed with Nashik Engineering Cluster</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" center">Polytechnic is the best option After tenth in order to get early jobs: Dr. M. V. Mankar</p>
                                                        <center>
                                                            <div class="department-btn">
