                                    ...
                                    <div id="carouselExampleDark" class="carousel carousel-dark slide widget category">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="10000">
                                                <div style="min-height: 200px;">
                                                    <div class="carousel-caption d-block text-start py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Mechanical Engineering Department Second year students got second price</strong>
                                            ...
                                            <div class="carousel-item" data-bs-interval="10000">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Refresher Course for Direct Second Year Students</strong>
                                            ...
                                            <div class="carousel-item" data-bs-interval="10000">
                                                <div style="min-height: 200px;">
                                                    <div class="carousel-caption d-block text-start pt-5" style=" font-size: 15px">
                                                        <p class="ps-5 news">Institute Level Admission Round 2023-24</strong>
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">OTO Registration Circular</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Anti-Ragging Committee</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">ICC(Internal Complaint Committee) Committee</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Grievance Redressal Committee(GRC) for Faculty/Staff</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">POST SSC Diploma admission circular</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Photocopy Schedule</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">150th Birth Anniversary Celebration of Chhatrapati Rajarshi Shahu Maharaj</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Umesh Nagdive Sir has Visited FC Center(CSMSS COP)</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Appointment of various posts 2023</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">State Level Technical Paper Presentation Competition</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">List of selected candidates in John Deere India Pvt Ltd. 2022-23</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Class test 1 time table AY 2022-23 (Even)</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">जॉन डियर इंडिया प्रा.ली. तर्फे कॅम्पस ड्राईव्ह</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Fees structure for academic year 2022-23</strong>
                                                                <center>
                                                                    <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Against CAP General Merit List A.Y. 2022-23 </strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">MSBTE One time opportunity (OTO) registration time table 2022-23</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">पॉलिटेक्निक शैक्षणिक वर्ष २०२२-२३ अनुत्तीर्ण विद्यार्थांना दिलासा</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">CSMSS Polytechnic च्या सर्व शाखांना MSBTE कडून excellent दर्जा</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="text-center ps-5 news">छत्रपती शाहू पॉलिटेक्निक व मसिआमध्ये सामंजस्य करार</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">online student grievance notice</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Class test 1 time table (s-2022)</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">छत्रपती शाहू पॉलीटेक्निकने राखली निकालाची उज्ज्वल परंपरा</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">MAGICx Interview Series Announcement for 15 January 2022!</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Organized Virtual Surya Namaskar Programme Event held at CSMSS College of Polytechnic.</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Arrangement of Covid-19 Mega Vaccination for all the students who are above 15 years old on the Occasion of National Youth Day January 12, 2022.</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Visit of Delegation of Directorate of Technical Education, Uttar Pradesh for Study tour of Polytechnic Colleges in Maharashtra.</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">TC Issue of Final year Pass out student</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">CSMSS College of Polytechnic Fees for academic year 2017-18</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">MOU has signed with Nashik Engineering Cluster</strong>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class="ps-5 news">Polytechnic is the best option After tenth in order to get early jobs: Dr. M. V. Mankar</strong>
                                                        <center>
                                                            <div class="department-btn">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                         ...
                         <div class="facility-details-img mb-30">
                            ...
                            <h2 class="mt-4">PHOTOCOPY SCHEDULE..</h2><br>
                            
                                    <img src="assets/img/news-and-events/news/photocopy-schedule.jpg"alt="thumb" class="card shadow-lg" style=" width: 100%;" ><br><br>
                                    CLICK HERE TO SEE  PHOTOCOPY SCHEDULE FOR SUMMER 2023 EXAM.
                                </div>
                                </div>
                                </div>
                                </div>
