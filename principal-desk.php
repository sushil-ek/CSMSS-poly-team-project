...
<body>
    ...
    <main class="main">
        ...
        <!-- breadcrumb -->
        <div class="site-breadcrumb d-none d-lg-block" style=" background: url(assets/img/p-desk/image.png); background-size: 100% 100%; object-fit: cover; " >
            <div class="container">
        ...
        <div class="site-breadcrumb d-lg-none" style=" background: url(assets/img/video/clg-img-1.png); background-size: 100% 100%; object-fit: cover;" >
            <div class="container">
                <h2 class="breadcrumb-title">Principal Desk</h2>
                <ul class="breadcrumb-menu">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8">
                            <div class="department-details">
                                ...
                                <div class="department-details">
                                    ...
                                    <p class="mb-20">
                                        Chhatrapati Shahu Maharaj Shikshan Sanstha’s (CSMSS) College of Polytechnic is one of the leading technical education institute in the State of Maharashtra. The College of Polytechnic was established in 2009. It is situated in a pleasant natural atmosphere. The college has been at the vanguard of continuous development in technical education since its inception. The institute has been awarded Excellent Remark continuously to all the programmes by the Maharashtra State Board of Technical Education, Mumbai (MSBTE). The growth of the institution has been sustained by the strong technical support of various renowned industries. The College of Polytechnic is certified by ISO 21001:2018 Educational Organizations Management system, ISO 50001:2018 Energy Management System, ISO 14001:2015 Environmental Management System.
                                    </p>
                                    </div> 
