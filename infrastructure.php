                        ...
                        <div class="tab-content show">
                            ...
                            <div id="campus" class="container tab-pane active show"><br>
                                <div class="department-details-img mb-30">
                                    <img src="assets/img/infrastructure/campuspoly.png" alt="" style="height: 472px; width: 723px;">
                                </div>
                            ...
                            <div id="Canteen" class="container tab-pane fade"><br>
                                <div class="department-details-img mb-30">
                                    <img src="assets/img/infrastructure/canteen.jpg" alt="" style="height: 472px; width: 723px;">
                                </div>
                                <h3 class="mb-20">Canteen</h3>
                                <p class="mb-20">A spacious and well-designed canteen with a modern kitchen that provides
                            ...
                            <div id="Library" class="container tab-pane fade"><br>
                                <div class="department-details-img mb-30">
                                    <img src="assets/img/infrastructure/library.jpg" alt="" style="height: 472px; width: 723px;">
                                </div>
                                <h3 class="mb-20">Library</h3>
                                <p class="mb-20">Includes 25 national journals, 1609 book titles, 155521 volumes, an e-library, newspapers, and magazines.</p>
                            </div>
                            <div id="Gymnasium" class="container tab-pane fade"><br>
                                <div class="department-details-img mb-30">
                                    <img src="assets/img/infrastructure/gym.jpg" alt="" style="height: 472px; width: 723px;">
                                </div>
                                <h3 class="mb-20">Gymnasium</h3>
                                <p class="mb-20">Fully equipped gym with trained instructors available for students and staff.</p>
                            </div>
                            ...
                            <div id="Hospital" class="container tab-pane fade"><br>
                                <div class="department-details-img mb-30">
                                    <img src="assets/img/infrastructure/hospital.jpg" alt="" style="height: 472px; width: 723px;">
                                </div>
                            ...
                            <div id="Basketball" class="container tab-pane fade"><br>
                                <div class="department-details-img mb-30">
                                    <img src="assets/img/infrastructure/court.jpg" alt="" style="height: 472px; width: 723px;">
                                </div>
