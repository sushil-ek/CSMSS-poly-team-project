                                    ...
                                    <div id="demo" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <img src="assets/img/department/vlc-lab-co" alt="industrial-visit-me" style="height:450px ; width:800px">
                                            </div>
                                            ...
                                            <!-- img vlc lab open-->
                                            <div class="carousel-item">
                                                <img src="assets/img/department/industrial-visit-co.Ltd" alt="vlc lab" style="height:450px ; width:800px">
                                            </div>
                                            <!-- img vlc lab close-->
                                        ...
                                        <table class=" table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Mrs. POPHALE RUPALI SUBHASH</td>
                                                    <td>
                                                        B.E., M.TECH.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Pophale Madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Borlepawar Madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\sonu samrat.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Miss. PATHAN HEENA MAHEBOOB</td>
                                                    <td>
                                                        B.E.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Pathan Madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Mrs. KUDLIKAR ANURADHA KIRAN</td>
                                                    <td>
                                                        B.E.,M.E.
                                                    </td>
                                                    <td class=>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Kudlikar Madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Mrs.SONAWANE KALYANI ANIKET</td>
                                                    <td>
                                                        B.E.,M.E
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Sonawane Madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Mr.DHOPTE MANGESH AMBADAS</td>
                                                    <td>
                                                        B.E.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\mangesh dhopte.ppsx" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\wagh madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Miss.JADHAV MOHINI GULAB</td>
                                                    <td>
                                                        B.E.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Mohini Jadhav CO.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Rani Zalke.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\surwade madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        12 </td>
                                                    <td>Mrs.LIPANE SHRADDHA UMESH</td>
                                                    <td>
                                                        B.E., M.TECH.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Mrs. Shradha Umesh Lipane.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> Ms.KULKARNI RASHMI LAXMIKANT</td>
                                                    <td>
                                                        B.E.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Ms. Rashmi Laxmikant Kulkarni.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Ms.JAYBHAYE PRIYANKA BABASAHEB</td>
                                                    <td>
                                                        B.E, M.E
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Mrs. Priyanka Babasaheb Jaybhaye.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Mrs.TURUKMANE ASHVINI MILIND</td>
                                                    <td>
                                                        M.SC.(CHEMISTRY)B.ED.
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Mrs.TURUKMANE ASHVINI MILIND.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Mr. KHILLARE SUDARSHAN DILIP</td>
                                                    <td>
                                                        M.SC.(PHYSICS)
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Mr. KHILLARE SUDARSHAN DILIP.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> Mrs.MOPARI SHILPA SHRIKANT</td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Mopari Madam.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="assets\pdf\department-pdf\CO-PDF\Dr. Vishnu Chhabu Shelke.pdf" target="_blank" class="btn text-white"
                                                            id="view-button">
                                                            <i class="fa-regular fa-eye text-white"></i> View
                                                        </a>
                                                    </td>
                                                    ...
                                                    <div class="accordion" id="accordionExample">
                                                        ...
                                                        <div class="accordion-item p-2 ">
                                                            <h2 class="accordion-header" id="headingTwo">
                                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                                    data-bs-target="#collapseSecond" aria-expanded="true" aria-controls="collapseSecond">
                                                                    STUDENT'S ACHIEVEMENT
                                                                </button>
                                                            </h2>
                                                            <div id="collapseSecond" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                                                data-bs-parent="#accordionExample">
                                                                <div class="accordion-body">
                                                                    <div class="table-responsive">
                                                                        <table class=" table table-bordered table-hover">
