                                    ...
                                    <div id="carouselExampleDark" class="carousel carousel-dark slide widget category">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" news">Appointment of various posts 2023</p>
                                                        <center>
                                                            <div class="department-btn">
                                            ...
                                            <div class="carousel-item">
                                                <div style="min-height: 200px; ">
                                                    <div class="carousel-caption d-block text-start py-md-5 py-lg-0" style=" font-size: 15px">
                                                        <p class=" news">Visit of Delegation of Directorate of Technical Education, Uttar Pradesh for Study tour of Polytechnic Colleges in Maharashtra.</p>
                                                        <center>
                                                            <div class="department-btn">
...
Chatrapati Shahu Maharaj Shikshan Sanstha’s College of Polytechnic has signed membership of understanding with Nashik Engineering Cluster. Under this project we have given training of CNC, Automation and information technology to more than 100 students. for this program Principal CSMSS College of Polytechnic, Prof. Ganesh Dongre, TPO Prof. Sagar Avhale , Mr. Nitin Jadhav, HOD Machanical  Engg., Nilesh Borade, Trainer CNC of NEC, Mr Faruque, placement Head of NEC, Mr Subhashish Roy, CEO Nashik Engineering Cluster  were present for the same. Under this it is planned to conduct various skills development and training activities.
