  ...
  <nav aria-label="breadcrumb">
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                       ...
                       <h2 class="mt-4">Visit of Delegation of Directorate of Technical Education, Uttar Pradesh for Study tour of Polytechnic Colleges in Maharashtra..</h4>   
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news-and-events/news/visit-delegation-uttar-pradesh.jpg" class="card shadow-lg" style=" width: 100%;"   alt="thumb">
                                </div>
