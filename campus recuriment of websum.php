    ...
    <main class="main">
       ...
       <!-- breadcrumb -->
        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of websum softwares images/college staff.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of websum softwares images/college staff.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of websum softwares images/interview img 1.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of websum softwares images/interview img 1.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of websum softwares images/interview img 2.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of websum softwares images/interview img 2.jpg"class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of websum softwares images/student class.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of websum softwares images/student class.jpg" class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
