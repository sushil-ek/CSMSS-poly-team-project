            ...
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                      ...
                      <h1 style=" border-bottom: 3px solid orange;">News</h1>
                       ...
                       <h2 class="mt-4">Grievance Redressal Committee(GRC) for Faculty/Staff..</h2>   
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news-and-events/news/grc.jpeg"  class="card shadow-lg" style=" width:100%;"  alt="thumb">
                                </div>


This is inform you that in tune with the policy of CSMSS College of Polytechnic the Committee is constituted under Grievance Redressal cell (GRC) to Resolve the Complaints of faculty/staff.
