                            ...
                            <div class="col-md-12 col-lg-7">
                                <div class="hero-content">
                                    ...
                                    <div class="hero-btn" data-animation="fadeInUp" data-delay="1s">
                                        <a href="college.php" class="theme-btn">About More<i
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Our library offers a range of books and resources to support student's <span class="hide-word"> journey. </span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Helping students launch their careers through <span class="hide-word"> strong </span>industry connections.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                                ...
                                <div class="about-bottom">
                                    <!-- button  -->
                                    <a href="collegec.php" class="theme-btn">Discover More<i
                                            class="fas fa-arrow-right-long"></i></a>
                ...
                <div class="event-slider owl-carousel owl-theme">
                    <div class="event-item">
                        ...
                        <div class="event-info">
                            ...
                            <div class="event-btn">
                                <a href="event.php" class="theme-btn">Join Event<i
                                        class="fas fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="event-item">
                        ...
                        <div class="event-info">
                            ...
                            <div class="event-btn">
                                <a href="event" class="theme-btn">Join Event<i
                                        class="fas fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="site-heading text-center">
                            ...
                            <p>The College of Polytechnic Gallery supports artistic exploration and education through
                                diverse exhibitions and community engagement.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-img">
                                <img src="assets/img/blog/new1.jpg" class="w-100" alt="Thumb"
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="blog-single.php">
                                        <a href="newsmechanical.php">Instructions to follow Institute Level Admission Round
                                            2023-24</a></a>
                                </h4>
                                <a class="theme-btn" href="news.php">Read More<i
                                        class="fas fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".50s">
                            <div class="blog-date"><i class="fal fa-calendar-alt"></i> June 18, 2024</div>
                            <div class="blog-item-img">
                                <img src="assets/img/blog/news2.jpg" class="w-100" alt="Thumb"
                                    style="height:250px;width:320px">
                            </div>
                            <div class="blog-item-info">
                                <hr>
                                <h4 class="blog-title">
                                    <a href="news-covid-19.php">Arrangement of Special vaccination drive against covid</a>
                                </h4>
                                <a class="theme-btn" href="news.php">Read More<i
                                        class="fas fa-arrow-right-long"></i></a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".75s">
                            <div class="blog-date"><i class="fal fa-calendar-alt"></i> June 18, 2024</div>
                            <div class="blog-item-img">
                                <img src="assets/img/blog/news3.jpg" class="w-100" alt="Thumb"
                                    style="height:250px;width:300px">
                            </div>
                            <div class="blog-item-info">
                                <hr>
                                <h4 class="blog-title">
                                    <a href="newsonline-stu.php">online student grievance notice and redressal
                                        mechanism</a>
                                </h4>
                                <a class="theme-btn" href="news.php">Read More<i
                                        class="fas fa-arrow-right-long"></i></a>
                ...
                <div class="container">
                    ...
                    <div class="testimonial-slider owl-carousel owl-theme">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-author-img">
                                    <img src="assets/img/testimonial/img1.jpeg" alt="" class="test-one fs-3 "
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-author-img">
                                    <img src="assets/img/testimonial/imgg.jpeg" alt="" class="test-two"
                                        style="width:50px; height: 50px">
                                </div>
                                <div class="testimonial-author-info">
                                    <h4>Shraddha Gire</h4>
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-author-img">
                                    <img src="assets/img/testimonial/img2.jpeg" alt="" class="test-three"
                                        style="width:50px; height: 50px">
                                </div>
                                <div class="testimonial-author-info">
                                    <h4>Anuj Shimpne</h4>
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-author-img">
                                    <img src="assets/img/testimonial/img4.jpeg" alt="" class="test-four"
                                        style="width:50px; height: 50px">
                                </div>
                                <div class="testimonial-author-info">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-author-img">
                                    <img src="assets/img/testimonial/img3.jpeg" alt="" class="test-five"
                                        style="width:50px; height: 50px">
                                </div>
                                <div class="testimonial-author-info">
                    ...
                    <div class="row flex-nowrap overflow-auto course-scroll">
                        <div class="col-lg-6 mx-auto">
                            <div class="site-heading text-center">
                                ...
                                <p>To provide value based technical education so as to meet the need's of industry and
                                    society</p>
                            </div>
                        </div>
                    </div>
                    <div class="row flex-nowrap overflow-auto course-scroll">
                            ...
                            <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                                ...
                                <div class="course-content">
                                    ...
                                    <p class="course-text-one">
                                        The Civil Engineering Department, established in 2009, offers a full-time
                                        diploma with skilled faculty, well-equipped labs, and outstanding student
                                        performance.</p>
                        ...
                        <div class="col-auto">
                            <div class="course-item wow fadeInUp" data-wow-delay=".50s">
                                ...
                                <div class="course-content">
                                    <h4 class="course-title mt-4">
                                        <a href="electrical-department.php">Electrical Engineering</a>
                                    </h4>
                                    <p class="course-text-one">
                                        The Electrical Engineering Department, estd. in 2010, offers diverse career
                                        opportunities in power, electronics, and communication through comprehensive
                                        technical education.
                                    </p>
                                    <div class="course-bottom">
                                        <div class="course-bottom-left">
                        ...
                        <div class="col-auto">
                            <div class="course-item wow fadeInUp" data-wow-delay=".75s">
                                ...
                                <div class="course-content">
                                    <h4 class="course-title mt-4">
                                        <a href="mechanical-department.php">Mechanical Engineering</a>
                                    </h4>
                                    <p class="course-text-one">
                                        The Mechanical Engineering Department, estd. 2009, offers diverse career
                                        opportunities in industries like aerospace, robotics, and manufacturing. <span
                                            class="d-md-block d-lg-none"> & contributing to India’s tech-driven economy.
                                        </span>
                                    </p>
                                    <div class="course-bottom">
                                        <div class="course-bottom-left">
                        ...
                        <div class="col-auto">
                            <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                                ...
                                <div class="course-content">
                                    <h4 class="course-title mt-4">
                                        <a href="electronics-telecommunication-department.php">Electronics & Telecom </a>
                                    </h4>
                                    <p class="course-text-one">
                                        The Electronics & Telecommunication Engineering Department, estd. 2009, equips
                                        students for careers in advanced communication, embedded systems, and modern
                                        electronic technologies & vbla vflashv</p>
                                    <div class="course-bottom">
                                        <div class="course-bottom-left">
                                            <span><i class="far fa-users"></i>60 Seats</span>
                                            <span><i class="far fa-clock"></i>03 Duration</span>
                        ...
                        <div class="col-auto">
                            <div class="course-item wow fadeInUp" data-wow-delay=".50s">
                                ...
                                <div class="course-content">
                                    <h4 class="course-title mt-4">
                                        <a href="computer-department.php">Computer Engineering</a>
                                    </h4>
                                    <p class="course-text-one">
                                        The Computer Engineering Department, estd. 2009, equips students with skills in
                                        software design and development, offering vast career opportunities in global IT
                                        industries<span class="d-md-none d-lg-block"> & contributing to India’s
                                            tech-driven economy. </span></p>
                                    <div class="course-bottom">
                                        <div class="course-bottom-left">
                        ...
                        <div class="col-auto">
                            <div class="course-item wow fadeInUp" data-wow-delay=".75s">
                                ...
                                <div class="course-content">
                                    <h4 class="course-title mt-4">
                                        <a href="AI-ML-department.php">Artificial Intelligence </a>
                                    </h4>
                                    <p class="course-text-one">
                                        The AI & ML department, estd. 2022–23, aims to provide quality education, foster
                                        innovation, and prepare students for industry roles through strong academics,
                                        teamwork, and ethical values. </p>
                                    <div class="course-bottom">
                                        <div class="course-bottom-left">
                                            <span><i class="far fa-users"></i>60 Seats</span>
                                            <span><i class="far fa-clock"></i>03 Duration</span>
            ...
            <div class="team-area py-120">
                <div class="container">
                    ...
                    <div class="testimonial-slider d-lg-none  owl-carousel owl-theme">
                        <!-- one Member -->
                        <div class="team-item">
                            <a href="president_home.php" class="w-100">
                            <div class="team-img">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="president_home.php">Mr. Ranjeet P. Mulay</a></h5>
                                    <span>President</span>
                                </div>
                            </div>
                        </div>
                        <!-- Two Member -->
                        <div class="team-item">
                            <a href="secretary_home.php" class="w-100">
                            <div class="team-img">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="secretary_home.php">Mr. Padmakar H. Mulay</a></h5>
                                    <span>Secretary</span>
                                </div>
                            </div>
                        </div>
                        <!-- Third Member -->
                        <div class="team-item">
                            <a href="administrative_Officer_home.php" class="w-100">
                            <div class="team-img">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="administrative_Officer_home.php">Dr. Shrikant G. Deshmukh</a></h5>
                        ...
                        <!-- Fourth Member -->
                        <div class="team-item">
                            <a href="principal_home.php" class="w-100">
                            <div class="team-img">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="principal_home.php">Dr. Shashikant R. Dikle</a></h5>
                                    <span>Principal</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="partner-area bg pt-50 pb-50">
                <div class="container">
                    <div class="partner-wrapper partner-slider owl-carousel owl-theme">
                        ...
                        <a href="https://www.maharashtra.gov.in/"> <img src="assets/img/partner/goverment.png"
                                alt="thumb"></a>
                        <a href="https://htedu.maharashtra.gov.in"> <img src="assets/img/partner/lamp.png"
                                alt="thumb"></a>
                        <a href="https://htedu.maharashtra.gov.in"> <img src="assets/img/partner/mhgov.png"
                                alt="thumb"></a>
