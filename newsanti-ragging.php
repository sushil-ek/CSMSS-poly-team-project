       ...
       <div class="department-single-area py-120">
            <div class="container">
                <div class="department-single-wrapper">
                    <div class="row">
                         ...
                         <div class="col-xl-8 col-lg-8" style="overflow-y:scroll; scrollbar-width: none; height: 100vh;">
            ...
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                         ...
                         <h2 class="mt-4">Anti-Ragging Committee</h4>
                                    <br>
                                <img src="assets/img/news-and-events/news/anti-ragging.jpeg" class="card shadow-lg" style=" width: 100%;" ><br>
                                     this committee is formed to ensured complete ragging free environment in CSMSSCOP Campus as per the guidlines of AICTE ,New Delhi.
                            </div>
                        </div>
                    </div>
                </div>
