...
<body>
    ...
    <main class="main">
        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of bajaj auto Ltd/certificate distribute.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of bajaj auto Ltd/certificate distribute.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of bajaj auto Ltd/interview.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of bajaj auto Ltd/interview.jpg "class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus interview of bajaj auto Ltd/student class.jpg">
                    <img src="assets/img/photos-Gallery/campus interview of bajaj auto Ltd/student class.jpg"class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
