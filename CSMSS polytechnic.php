        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/college staffs.jpg">
                    <img src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/college staffs.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/interview.jpg">
                    <img src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/interview.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php"a data-fancybox="gallery"
                    ...
                    <img src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/staff with stu.jpg " class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    ...
                    data-caption="Sheep">
                    <img src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/welcome board.jpg"class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/computer lab.jpg">
                    <img src="assets/img/photos-Gallery/chhatrapati shahu polytechnic/computer lab.jpg" class="card shadow-lg" style="height:250px; width:300px;">
                </a>
            </div>
