        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive of core project engineers and consultants/certificate.jpg">
                    <img src="assets/img/photos-Gallery/campus drive of core project engineers and consultants/certificate.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive of core project engineers and consultants/interviews.jpg">
                    <img src="assets/img/photos-Gallery/campus drive of core project engineers and consultants/interviews.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus drive of core project engineers and consultants/students.jpg">
                    <img src="assets/img/photos-Gallery/campus drive of core project engineers and consultants/students.jpg" class="card shadow-lg" style="height:250px; width:300px;">
