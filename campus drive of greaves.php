        ...
        <div class="department-single-area py-120">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                 data-src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/certificate distribute.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/certificate distribute.jpg" class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/college staffs.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/college staffs.jpg" class="card shadow-lg"style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/staff speech.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/staff speech.jpg " class="card shadow-lg" style="height:250px; width:300px;">
            ...
            <div class="col-lg-4 col-12 col-md-6 mb-4 text-center">
                <a href="campus int of john.php" a data-fancybox="gallery"
                    data-src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/students info.jpg">
                    <img src="assets/img/photos-Gallery/campus recuritment of greaves cotton Ltd/students info.jpg"class="card shadow-lg"style="height:250px; width:300px;">
                </a>
            </div>
