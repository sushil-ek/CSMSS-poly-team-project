            ...
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page">News</li>
                      ...
                      <h1 style=" border-bottom: 3px solid orange;">News</h1>
                       ...
                       <h2 class="mt-5">ICC(Internal Complaint Committee) Committee..</h2>   
                       <br>          
                            <div class="facility-details-img mb-30">
                                    <img src="assets/img/news-and-events/news/icc-committee.jpeg" class="card shadow-lg" style=" width:100%;"  alt="thumb">
                                </div>


ICCis (Internal Complaint Committee) Committee.ICC Committee is consists of 10 members.this committee is formed as per the AICTE regulation 2016.
Important Links
